| Item | Value |
| --- | --- |
| PII present | {{ pii_present or 'Yes / No' }} |
| GDPR legal basis | {{ gdpr_legal_basis or '[TBD — e.g., Art. 6(1)(b) contract performance]' }} |
| Data minimisation | {{ data_minimisation or '[TBD — what data is retained after processing]' }} |
